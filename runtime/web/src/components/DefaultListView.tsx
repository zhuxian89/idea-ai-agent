              ...
              >
                ...
                {isRootView ? (
                  <>
                    ...
                    {isGitWorktree && onRemoveWorktree ? (
                      <button
                        type="button"
                        onClick={() => {
                          onRemoveWorktree?.();
                    ...
                    {(isGitRepo && (onCreateWorktree || onSwitchWorktree)) || (isGitWorktree && onRemoveWorktree) ? (
                      <div
                        style={{
                          height: "1px",
                          background: "var(--border-color)",
